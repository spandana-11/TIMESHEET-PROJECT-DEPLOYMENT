              ...
              <div className="ti-data-field-container pt-4">
                ...
                <div className="d-flex justify-content-between">
                  <div className="m-1" style={{ display: "flex", alignItems: "center" }}>
                    <label htmlFor="fromDate" style={{ color: "white", marginRight: "8px" }}>Start Date: </label>
                    <input
                      type="text"
                      id="fromDate"
                      className="mx-1"
                ...
                <div className="d-flex justify-content-between">
                  <div className="m-1" style={{ display: "flex", alignItems: "center" }}>
                    <label htmlFor="fromDate" style={{ color: "white", marginRight: "8px" }}>End Date : </label>
                    <input
                      type="text"
                      id="fromDate"
                      className="mx-1"
                ...
                <div className="d-flex justify-content-between">
                  <div className="m-1" style={{ display: "flex", alignItems: "center" }}>
                    <label htmlFor="emp_id" style={{ color: "white", marginRight: "7px" }}>EmployeeId: </label>
                    <input
                      type="text"
                      id="emp_id"
                ...
                <div
                  className="border table-responsive border-1 rounded p-4 border-black my-4 w-aotp"
