      ...
      await Promise.all(
        editableData.map(async (data) => {
          let response = await axios.put(
            `${serverUrl}/admin/working-hours/update`,
            data
          );
        })
      );
          ...
          <div className="AddTimesheet employeeEdit-container pt-4">
            ...
            <div className="d-flex justify-content-between align-items-center">
              <div className="d-flex align-items-center m-1">
                <label htmlFor="emp_id" className="mr-2 text-nowrap">Emp Id : </label>
                <input
                  type="text"
                  id="emp_id"
              ...
              <div className="d-flex align-items-center m-1">
                <label htmlFor="fromDate" className="mr-2 text-nowrap">Start Date: </label>
                <input
                  type="text"
                  id="fromDate"
                  className="form-control mx-2"
              ...
              <div className="d-flex align-items-center m-1">
                <label htmlFor="fromDate" className="mr-2 text-nowrap">End Date : </label>
                <input
                  type="text"
                  id="fromDate"
                  className="form-control mx-2"
